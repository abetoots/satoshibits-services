...
import { debounce, throttle, batchAsync } from './performance.mjs';
...
describe('performance', () => {
  ...
  describe('batchAsync', () => {
    ...
    it('should handle async errors', async () => {
      ...
      await expect(batchAsync(items, processItem, 2, 0))
  ...
  // timingUtils tests removed - export timingUtils from performance.mts if needed
});