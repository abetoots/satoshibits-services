...
export {
  ...
  type BrowserErrorInstrumentationConfig,
} from "./error-instrumentation.mjs";

export {
  BrowserConsoleInstrumentation,
  type BrowserConsoleInstrumentationConfig,
} from "./console-instrumentation.mjs";

export {
  BrowserNavigationInstrumentation,
  type BrowserNavigationInstrumentationConfig,
} from "./navigation-instrumentation.mjs";
